        ...
        while n != 0:
            ...
            if pair not in list_for_pairs and father != mother:
                ...
                for k in range(config["kids"]):
                    ...
                    kids_df.iloc[k]["number_of_p_fathers_new_codis_trio"], ids1 = find_father(index_list, columns_list,
                                                                                              temp_parents_df,
                                                                                              kids_df.loc[[k]], 3, 2,
                                                                                              config["codis_new"],
                                                                                              father, mother)
                    kids_df.iloc[k]["number_of_p_fathers_new_codis_duo"], ids2 = find_father(index_list, columns_list,
                                                                                             temp_parents_df,
                                                                                             kids_df.loc[[k]], 2, 2,
                                                                                             config["codis_new"],
                                                                                             father, mother)
                    kids_df.iloc[k]["number_of_p_fathers_new_plex_trio"], ids3 = find_father(index_list, columns_list,
                                                                                             temp_parents_df,
                                                                                             kids_df.loc[[k]], 3, 2,
                                                                                             config["new_plex"],
                                                                                             father, mother)
                    kids_df.iloc[k]["number_of_p_fathers_new_plex_duo"], ids4 = find_father(index_list, columns_list,
                                                                                            temp_parents_df,
                                                                                            kids_df.loc[[k]], 2, 2,
                                                                                            config["new_plex"],
                                                                                            father, mother)
                    kids_df.iloc[k]["number_of_p_fathers_combined_trio"], ids5 = find_father(index_list, columns_list,
                                                                                             temp_parents_df,
                                                                                             kids_df.loc[[k]], 3, 2,
                                                                                             config["combined"],
                                                                                             father, mother)
                    kids_df.iloc[k]["number_of_p_fathers_combined_duo"], ids6 = find_father(index_list, columns_list,
                                                                                            temp_parents_df,
                                                                                            kids_df.loc[[k]], 2, 2,
                                                                                            config["combined"],
                                                                                            father, mother)
